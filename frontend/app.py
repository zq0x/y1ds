...
with gr.Blocks() as app:
    ...
    btn_test.click(lambda selected_model,selected_config: docker_api("test", selected_model, selected_model_pipeline_tag,"what is the capital of Germany?",0.77,selected_config), inputs=[model_dropdown,selected_model_config_data], outputs=create_response)
